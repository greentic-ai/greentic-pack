...
pub fn canonical_wit_root() -> PathBuf {
    ...
    // Vendored checkout alongside this crate in mono-repo vendor trees.
    let workspace_vendor_sibling = manifest_dir.join("../greentic-interfaces-0.4.107/wit");
    if has_wit_files(&workspace_vendor_sibling) {
        return workspace_vendor_sibling
            .canonicalize()
            .expect("Failed to locate canonical WIT root");
    }
