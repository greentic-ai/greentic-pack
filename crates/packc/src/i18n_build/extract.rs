...
//!
//! Ported from `greentic-cards2pack/src/i18n_extract/` (extractor.rs + mod.rs)
//! into a single file so that `greentic-pack` has no cross-crate dependency on
//! `greentic-cards2pack`.
//!
//! # Extractable Fields
//!
...
// ---------------------------------------------------------------------------
// Tests — merged from extractor.rs and mod.rs
// ---------------------------------------------------------------------------
